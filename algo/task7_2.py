...
6. Циклическая буферная очередь на базе статического массива фиксированного размера.
Логика решения совпадает с эталонной, но я использовала counter вместо показателя пусто/полно.
'''
